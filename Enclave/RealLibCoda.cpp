...
INDEX cal_ob(INDEX offset) { return (offset / 16) * 1024 + offset % 16 + 16; }
...
extern "C" {
void coda_tx_abort(int code)
{
  coda_aborts++;
  coda_aborts_cur_tx++;
  if (coda_aborts_cur_tx > 200) Eabort("too many aborts!!");
}
}
